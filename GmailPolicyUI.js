...
class GmailPolicyUI {
    ...
    retention({
        ...
        retentionDays,
        methods = null,
        unexpectedLabelNames = null,
        expectedLabelNames = null,
    }) {
        this.GmailPolicy.retention({
            ...
            ...(methods
                ? {
                    methods: methods
                        .map(method => this.DoMethod(method))
                }
                : {}
            ),
            ...(unexpectedLabelNames
                ? {
                    unexpectedLabelIds: expectedLabelNames
                        .map(labelName =>
                            this.GmailPolicy
                                .labels
                                .getLabelByName(labelName)
            ...
            ...(expectedLabelNames
                ? {
                    expectedLabelIds: expectedLabelNames
                        .map(labelName =>
                            this.GmailPolicy
                                .labels
                                .getLabelByName(labelName)
