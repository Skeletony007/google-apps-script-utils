 ...
 * @typedef ApiRequestDefinitions
 * @property 'users.labels.create' - Creates a new label.
 * @property 'users.labels.list' - Lists all labels in the user's mailbox.
 * @property 'users.labels.patch' - Patch the specified label.
 * @property 'users.threads.get' - Gets the specified thread.
 * @property 'users.threads.delete' - Immediately and permanently deletes the specified thread. Any messages that belong to the thread are also deleted. This operation cannot be undone. Prefer threads.trash instead.
 * @property 'users.threads.modify' - Modifies the labels applied to the thread. This applies to all messages in the thread.
 * @property 'users.threads.trash' - Moves the specified thread to the trash. Any messages that belong to the thread are also moved to the trash.
 *
 * @type {ApiRequestDefinitions}
 */
GmailApi.requestTemplates = {
  'users.labels.create': parameters => ({
    method: 'POST',
